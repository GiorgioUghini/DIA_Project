...
\begin{figure}
    ...
    \makebox[\textwidth][c]{\includegraphics[width=0.80\textwidth]{sections/images/opt_constrained_regret.jpg}}
\end{figure}

\begin{figure}
    \caption{Reward}
    \label{fig:opt_constrained_reward}
    \makebox[\textwidth][c]{\includegraphics[width=0.80\textwidth]{sections/images/opt_constrained_reward.jpg}}
\end{figure}