Given that the product we want to study generates more interest in women rether than in men, we decided to focus our studies on women only. We also came to the conclusion that since a luxury scarf is usually bought from the middle and the upper class person, a minimum family yearly income bound was necessary to set our focus on only the users that are able to generate more impact on the analysis. We set this bound at \texteuro80.000 gross. Finally, we thought that since trends can vary among countries, considering only the italian population was the most reasonable choice to avoid unwanted biases.
