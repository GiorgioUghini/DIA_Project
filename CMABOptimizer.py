...
class CMABOptimizer():
    def __init__(self, max_budget, campaigns_number, step):
    ...
    def optimize(self, matrix):
        ...
        budget_assigned_old = [[ 0 for i in range(0, self.campaigns_number)]] * matrix.shape[1]
        budget_assigned_new = [[ 0 for i in range(0, self.campaigns_number)]] * matrix.shape[1]
