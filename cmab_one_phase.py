...
for e in range(0, n_experiments):
    ...
    envs = [CMABEnvironment(budgets=budgets_j[0], sigma=sigma, userType=0), WIPEnv(budgets=budgets_j[1], sigma=sigma, userType=1), WIPEnv(budgets=budgets_j[2], sigma=sigma, userType=2)]
